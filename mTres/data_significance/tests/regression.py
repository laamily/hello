...
class TestRegressionMethods(unittest.TestCase):
    ...
    def test_bulk(self):
        ...
        beta_p, se_p, zscore_p, pvalue_p = data_significance.ridge(X, Y, alpha, alternative, nrand, 1)
        ...
        start_time = time.time()
        beta_t, se_t, zscore_t, pvalue_t = data_significance.ridge(X, Y, alpha, alternative, 0, 1)
